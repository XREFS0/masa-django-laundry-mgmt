        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("0", "Pending"), ("1", "In-progress"), ("3", "Done"), ("4", "Picked Up")],
                        default=0,
                        max_length=2,
                    ),
                ),
                (
                    "payment",
                    models.CharField(choices=[("0", "Unpaid"), ("1", "Paid")], default=0, max_length=2),
                ),
